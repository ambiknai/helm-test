...
# What’s new in Chart Version 2.1.1

With ibm-object-storage-plugin chart version 2.1.1, the following new features are available:

* "default" value can be set in the PVC for ibm.io/tls-cipher-suite to mount the bucket using OS supported default TLS cipher suite value

# Fixes
* Issue in upgrading the chart using `helm ibmc upgrade` command is fixed
* CVE-2020-28851
